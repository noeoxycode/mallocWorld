...
char *** creatData(){
    ...
    char data[34][6][50]={{"1","Epee en bois","Arme","10 durabilite","1 maximum","1 degat"},
                          {"2","Pioche en bois","Outil","10 durabilite","1 maximum","1 degat"},
                          {"3","Serpe en bois","Outil","10 durabilite","1 maximum","1 degat"},
                          {"4","Hache en bois","Outil","10 durabilite","1 maximum","1 degat"},
                          ...
                          {"12","Pioche en pierre","Outil","10 durabilite","1 maximum","2 degat"},
                          {"13","Serpe en pierre","Outil","10 durabilite","1 maximum","2 degat"},
                          {"14","Hache en pierre","Outil","10 durabilite","1 maximum","2 degat"},
                          ...
                          {"23","Pioche en fer","Outil","10 durabilité","1 maximum","3 degat"},
                          {"24","Serpe en fer","Outil","10 durabilité","1 maximum","3 degat"},
                          {"25","Hache en fer","Outil","10 durabilité","1 maximum","3 degat"},
...
char *** maps(){
    ...
    char map[15][4][30]={{"-3","Portail entre zones || & |||","6","0"},
                         {"-2","Portail entre zones | & ||","5","0"},
                         {"-1","Case infranchissable","4","0"},
                         {"0","Zone libre pour se déplacer","4","0"},
                         {"1","Joueur","4","0"},
                         {"2","PNJ","4","0"},
                         {"3","Plante zone I","1","7"},
                         {"4","Rocher zone I","1","6"},
                         {"5","Bois zone I","1","5"},
                         {"6","Plante zone II","2","18"},
                         {"7","Rocher zone II","2","17"},
                         {"8","Bois zone II","2","16"},
                         {"9","Plante zone III","3","29"},
                         {"10","Rocher zone III","3","28"},
                         {"11","Bois zone III","3","27"},
    };
    for(int x=0;x<15;x++){
        for(int y=0;y<4;y++) {
            strcpy(res[x][y],map[x][y]);
        }
    }
    return res;
}